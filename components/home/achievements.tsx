...
const achievements: Achievement[] = [
  {
    ...
    title: "Winner of Volleyball Tournament at District Level",
    colorClass: "text-yellow-600 dark:text-yellow-400",
  },
  {
    icon: <Medal className="h-6 w-6" />,
    title: "Winner of Move it with Aptos Hackathon ($200 Prize)",
    colorClass: "text-blue-600 dark:text-blue-400",
  },
  {
    icon: <Award className="h-6 w-6" />,
    title: "Winner of HackSRM 5.0 ($100 Prize)",
    colorClass: "text-green-600 dark:text-green-400",
  },
  {
    icon: <Trophy className="h-6 w-6" />,
    title: "Nestle Internship Challenge Winner",
  ...
  },
  {
    ...
    title: "Deloitte Cybersecurity Virtual Intern ",
    colorClass: "text-red-600 dark:text-red-400",
  },
  {
    icon: <Code className="h-6 w-6" />,
    title: "Social Media Head of University Student Council",
