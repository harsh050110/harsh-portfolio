        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground">
              ...
              <p>
               Alongside development, I’m actively strengthening my foundation in Data Structures & Algorithms, which enables me to write efficient, maintainable code and think systematically while solving real-world problems.
              </p>
            </div>
              ...
              <CardContent className="p-4">
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span>
                      Arthasya Communication&apos;s Technical Team as Convener, decreasing bugs and errors engagement by 20% through committee formation and industry-aligned website redesigns.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2 font-bold">•</span>
                  ...
                  <li className="flex items-start">
                    <span className="text-primary mr-2 font-bold">•</span>
                    <span>
                      Won Nestle Competition in Virtual Medium.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2 font-bold">•</span>
                    <span>
                      Awarded $100 at Move it with Aptos event.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2 font-bold">•</span>
                    <span>
                      Received $50 Marbelism Track Prize at HACKSRM 2.0 2025.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2 font-bold">•</span>
                    <span>
                      Runner Up!  at Hack-o-shop.
                    </span>
                  </li>
                </ul>
              </CardContent>
